...
function addEditUser_course($Userarr){
    if ($Userarr['ID'] > 0){
        ...
        $sqlstr = "insert into users_courses (arabicname,engname,nationalid,mobilenum,tasneefnum,email,workname,location,studentlevel,courseID,hashkey,regdate,ispay) VALUE "
                ...
                . "'{$Userarr['studentlevel']}',{$Userarr['courseID']},'{$Userarr['hashkey']}','{$Userarr['regdate']}',0)";
