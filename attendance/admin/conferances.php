...
if(isset($_GET["delete"])){
    ...
    if(delete ("conferances",$_GET["delete"]))
        header("Refresh:0; url=conferances.php");
}
...
<tbody>
<?php
tableheader($_SESSION["doc_adminID"],"conferances","List of Conferances");
?>
<tr>
...
<span class="title">Conferances List</span>
...
<a href="./addeditconf.php">Add Conferance</a>
</span>
</div>
        ...
        <table width="100%" class="sortedTable" style="visibility: visible;">
            <tbody>
                <tr class="defaultRowHeight">
                    <td class="topTitle"><a href="javascript:void(0)" tableindex="0" order="asc" column_name="null" style="vertical-align: middle;">Conferance Name</a></td>
                ...
                $Courses = getCofnerances("",null);
                $index = 1 ;
                if(isset($Courses))
                 while($course=mysqli_fetch_array($Courses)) {
                 ?>    
                <tr  class="<?php echo $index%2 == 0 ? "oddRowColor" : "evenRowColor" ?> defaultRowHeight">
                    <td><a class="editLink" href="./addeditconf.php?ID=<?php echo $course['ID'];?>"><?php echo $course['Conferancename']; ?></a></td>                                                              
                    <td class="centerAlign"><?php 
						$users = getUsersConf(" where confID={$course['ID']}",null);
						echo mysqli_num_rows($users); ?></td>
					<td class="centerAlign"><?php  echo $course['Description']; ?></td>
                    <td class="noWrap centerAlign">
                        <a href="./addeditconf.php?ID=<?php echo $course['ID'];?>"><img src="images/transparent.gif" class="sprite16 sprite16-edit" alt="Edit" title="Edit"></a>
